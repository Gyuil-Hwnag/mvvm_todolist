...
import com.example.mvvm_todolist.database.TodoDB.Companion.getInstance
...
//        ViewModelProvider(this, TodoViewModel.Factory(application)).get(TodoViewModel::class.java)
//    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addBtn.setOnClickListener {
            lifecycleScope.launch(Dispatchers.IO){
                model.insert(Todo2(binding.editText.text.toString()))
            }
